#this script is used for creating a vocabulary for the model
from tokeniser.tokeniser import Tokeniser

### attempt 1: using a simple corpus
# corpus = [
...
### attempt 2: using a larger corpus of text taken from my thesis notes
...
## attempt 3: using wikipedia data to generate a large vocabulary
